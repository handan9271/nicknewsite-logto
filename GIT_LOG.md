...
| b7c1dfe | 2026-04-17 | feat: 单 Part 练习模式（可选 Part 1/2/3 单独练习+评分） |
| 4610f64 | 2026-04-17 | feat: 多人对战支持练习范围选择（房主决定） |
| aec48b5 | 2026-04-17 | fix: 电脑端对话框放大至与输入框同尺寸 + 文字等比放大 |
| 8deefa5 | 2026-04-17 | fix: 学生打字时 Nick 随机轮换表情 |
| 26b4a7c | 2026-04-17 | feat: 检测乱打内容 → Nick 恼火 5 秒 |
| 292d65f | 2026-04-17 | feat: 直播提示徽章"雅思口语考试进行中"（Nick 右侧，点击关闭） |
...
| 41a1e9f | 2026-04-15 | feat: 判决词+评语中文毒舌化 + 历史记录提示动态化 |
| 1f5b742 | 2026-04-15 | feat: 语音输入停止时自动加标点 + 录音提示 |
| 7fa5419 | 2026-04-15 | fix: 雅思口语评分改为正确的 round up 规则 |
| ef84bb9 | 2026-04-15 | fix: 考官尼克 → 雅思考官尼克 |
