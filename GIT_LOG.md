...
### 📦 AI 评分 V4 校准（2026-04-25）

| Commit | Date | Message |
|--------|------|---------|
| (latest) | 2026-04-25 | feat: AI 评分 V4 — 109 个样本重新校准，MAE 0.31→0.15，新增 Band 6.0 锚点 |

### 📦 自由练习模式（2026-04-22）

| Commit | Date | Message |
|--------|------|---------|
| 11a8602 | 2026-04-22 | feat: 自由练习模式 — 语音输入 + 实时音频波形 + AI 分析评分 |

**自由练习模式功能：**
- 学生自由出题、自由回答，尼克全程聆听
- 可选 5/10/15 分钟练习时长
- 实时音频波形可视化（Web Audio API AnalyserNode）
- Nick 表情根据说话状态自然切换
- 结束后 AI 从逐字稿中识别 Q&A 对，用已有校准算法评分
- 新增 `/api/free-practice-verdict` 后端端点
- 游戏记录保存到 game_sessions（mode='free'）
- 每次扣 1 积分

### 📦 游戏导航按钮 + AI 评分 V3（2026-04-20）

| Commit | Date | Message |
|--------|------|---------|
| 1468abf | 2026-04-20 | fix: 游戏开始页按钮层级优化 — 模考按钮突出 + 导航链接弱化 |
| c1e01b3 | 2026-04-20 | feat: 游戏模考每局扣 1 积分 |
| bcd13c2 | 2026-04-20 | fix: 历史记录按钮大小统一 + ?view=history 跳转修复 |
| bfb8c59 | 2026-04-20 | feat: 游戏开始页+结束页增加导航按钮 + 主站 ?view= 跳转 |
| f26e563 | 2026-04-20 | feat: AI 评分 V3 — 42 个真实样本校准 + 口语练习页同步校准 |

### 📦 直播语音设备选择（2026-04-17）

| Commit | Date | Message |
|--------|------|---------|
| cf56fdd | 2026-04-17 | feat: 隐藏快捷键 F9 打开语音输入设备选择面板（直播连麦用） |
| 8873db9 | 2026-04-17 | fix: verdict 评语改为金色+字号加大，判决词字号加大 |
